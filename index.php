...
<?php
ob_start();
define('API_KEY','1075799831:AAHlCPAmI_5sWblLf2BF10bT86OITDgKwl0');
//tokenni yozing
$admin = "669114984";
...
Musica yuboring.Yuborgan musicangizga kanalingiz usernamesini qo'yadi va musica ma'lumotlarini tagiga yozib beradi va yana bir funksiya musicangizdan 25 soniya qirqibham beradi.Barchasi avtomatlashtrilgan.

Kanalga yuboriladigon buyruqlar:\n#cap so'z - xar bir kanalga joylangan musiqaning tagiga siz belgilagan matinni yoizp qo'yadi.\n#btn so'z - Do'stlarga ulashish tugmasidagi matinni ixtiyoriy so'zga o'zgartrish mumkin.Oldingi matnga qaytarish uchun shunchaki kanalga #btn deb yuboring.\nTuzuvchi: @Tilon";
  bot('sendmessage',[
    'chat_id'=>$chat_id,
    'text'=>$text,
    'parse_mode'=>'markdown',
...
'reply_markup'=>json_encode([
            'inline_keyboard'=>[
                [['text'=>"$buton", "url"=>"https://t.me/share/url?url=https://telegram.me/$muser/$aydi"]],
            ]
        ])
          ]);
del($doc_id.".mp3");
...
if ($reply == "Xabar matnini yuboringg:"){
$ex = explode("\n", $guruh);
foreach($ex as $for){
bot ('sendmessage', [
'chat_id'=> $for,
